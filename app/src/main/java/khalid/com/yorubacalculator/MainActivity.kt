...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("Translate", Translator.translate1to1000000(159))
        Log.d("Translate", Translator.translate1to1000000(1256))
        Log.d("Translate", Translator.translate1to1000000(700))
        Log.d("Translate", Translator.translate1to1000000(1875))
        Log.d("Translate", Translator.translate1to1000000(568))
        Log.d("Translate", Translator.translate1to1000000(198))
        Log.d("Translate", Translator.translate1to1000000(1107))
        Log.d("Translate", Translator.translate1to1000000(256789))
    ...
    private fun performCalculationAndDisplayTranslation() {
        ...
        try {
            ...
            if (mAddition == true) {
                display_view.text = display_view.text.toString() + "=" + (mValue1!! + mValue2!!)
                translateResult("+", mValue1!! + mValue2!! )
                mAddition = false
            }
